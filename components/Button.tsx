...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-teal-600 hover:bg-teal-700 text-white shadow-md shadow-teal-600/20 focus:ring-teal-500",
    secondary: "bg-white border border-stone-200 text-stone-700 hover:bg-stone-50 hover:border-stone-300 shadow-sm focus:ring-stone-400",
